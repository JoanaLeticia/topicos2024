...
@ApplicationScoped
public class AdministradorFileServiceImpl implements FileService {
    private final String PATH_USER = System.getProperty("user.home")
        + File.separator + "quarkus"
        + File.separator + "images"
        + File.separator + "administrador" + File.separator;
    ...
    public void salvar(Long id, String nomeImagem, byte[] imagem) {
        Administrador adm = admRepository.findById(id);
        try {
            adm.setNomeImagem(salvarImagem(nomeImagem, imagem));
        } catch (IOException e) {
